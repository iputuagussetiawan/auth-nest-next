...
export function AdminDashboard() {
    ...
    return (
        <div className="space-y-8">
            <section className="border-border/60 from-primary/10 via-background to-background rounded-[32px] border bg-gradient-to-br p-6 shadow-sm lg:p-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground max-w-2xl text-sm leading-6 lg:text-base">
                                Track platform health, user activity, role coverage, and account
                                verification from one unified dashboard.
                            </p>
                        </div>
                    </div>
            ...
            <div className="grid gap-4 xl:grid-cols-[1.6fr_1fr]">
                <Card className="border-border/60 rounded-[28px] shadow-sm">
                    <CardHeader className="pb-3">
                        ...
                        <CardDescription>
                            New registrations and sessions — last 6 months
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoading ? (
