            ...
            <DashboardPageCard className="overflow-visible">
                ...
                >
                    ...
                    >
                        {tabs.map(({ value, label, icon: Icon }) => (
                            <TabsTrigger
                                key={value}
                                value={value}
                                className="hover:bg-background/80 data-[state=active]:!border-primary data-[state=active]:!bg-primary/10 data-[state=active]:!text-primary lg:data-[state=active]:!border-primary lg:data-[state=active]:!bg-primary/10 !w-auto min-w-0 justify-center gap-2 rounded-lg border border-transparent px-3 py-2.5 text-xs font-medium transition-colors sm:px-4 sm:text-sm lg:!w-full lg:justify-start lg:rounded-l-none lg:rounded-r-lg lg:border-y-0 lg:border-r-0 lg:border-l-2 lg:px-4 lg:py-3"
                            >
                    ...
                    <div className="min-w-0 flex-1">
                        <TabsContent
                            value="profile"
                            className="mt-0 border-none p-0 focus-visible:outline-none"
                        >
