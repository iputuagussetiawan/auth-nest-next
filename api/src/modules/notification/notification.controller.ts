...
export class NotificationController {
    ...
    async list(@Req() req: any) {
        return successResponse(
            ...
            await this.notificationService.list(req.user.userId),
        )
    }
    ...
    async unreadCount(@Req() req: any) {
        return successResponse(
            ...
            await this.notificationService.unreadCount(req.user.userId),
        )
    }
    ...
    async markRead(@Req() req: any, @Param('id', ParseUUIDPipe) id: string) {
        return successResponse(
            ...
            await this.notificationService.markRead(id, req.user.userId),
        )
    }
}
